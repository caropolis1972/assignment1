...
/*
 * A checking account has a balance, and an annual interest rate of 0.01%. It is possible to
withdraw and deposit funds into the account which affects its balance. It is also possible to
